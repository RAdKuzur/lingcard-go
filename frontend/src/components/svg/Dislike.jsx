export default function Dislike({isDislike, dislike}) {
    return (
        <svg className="w-4 h-4 cursor-pointer" fill={`${isDislike ? 'black' : 'none'}`} stroke="currentColor"
             viewBox="0 0 24 24" onClick={dislike}>
